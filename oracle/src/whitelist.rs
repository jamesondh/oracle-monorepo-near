...
impl WhitelistHandler for Contract {
    ...
    fn add_to_whitelist(&mut self, new_requestor: RegistryEntryArgs) {
        ...
        logger::log_whitelist(&new_requestor_unwrapped.contract_entry, true); // TODO: use RegistryEntry inside logger
    ...
    fn remove_from_whitelist(&mut self, requestor: RegistryEntryArgs) {
        ...
        helpers::refund_storage(initial_storage, env::predecessor_account_id());
        logger::log_whitelist(&requestor_unwrapped.contract_entry, false);
